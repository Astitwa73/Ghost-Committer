...
class ScannerCore:
    ...
    def generate_full_report(self):
        ...
        # 4. TODOs
        self.report["todos"] = self.scanner.find_todos()

        # 5. Complex Functions
        self.report["complex_functions"] = self.scanner.find_complex_functions()

        # 6. Missing Docstrings
        self.report["missing_docstrings"] = self.scanner.find_missing_docstrings()
